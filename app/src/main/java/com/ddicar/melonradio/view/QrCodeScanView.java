...
public class QrCodeScanView extends AbstractView implements
	...
	private void adjustUI() {
		TextView qrCodeTitle = (TextView) view
				.findViewById(R.id.qr_code_scan_title);
		adjustTitleBarUnitSize(qrCodeTitle);
		adjustFontSize(qrCodeTitle);
	...
	private PreviewCallback mPreviewCallback = new PreviewCallback() {
		...
		public void onPreviewFrame(byte[] data, Camera camera) {
			...
			try {
				...
				ViewFlyweight.HARDWARE_BIND.setSn(text);
